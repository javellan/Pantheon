...
// Clearlight: We're just going to arbitrarily set it above the tab bar
// which is clamped between 15 and 60...
export const VIDEO_PLAYER_BOTTOM_INSET = 80
    ...
    <>
      ...
      <GestureDetector gesture={scrubPanGesture}>
        <View
          ...
          <View style={[a.w_full, a.relative, {height: 20}]}>
            <Animated.View
              style={[
                a.w_full,
                a.absolute,
                {backgroundColor: 'white', opacity: 0.2, bottom: 0, left: 0},
                trackStyle,
              ]}
            />
            <Animated.View
              style={[
                a.absolute,
                {bottom: 0, left: 0, backgroundColor: 'white'},
                barStyle,
              ]}
            />
          </View>
